...
<div class="container">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;租借日期
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></b></div>
	<form method="POST" action="my_rent_history_detail.php">
			<div style="text-align:center;">
				<select style="width:300px;height:300px;font-size:18px;" name="check" size="20"><font size="5">
				<?php
					$rkeyword=$_POST["keyword"];
					$id=$_COOKIE["id"];
					if($_POST["type"]=="rent_no" && $rkeyword!=NULL)
					{
						$sql = "SELECT * FROM 租借紀錄 where mem_id='$id' AND rent_no='$rkeyword' ORDER BY date";
						...
						$y=$row{"rent_no"};
						$accept=$row{"accept"};
						echo"<option value='$y'>"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".str_replace(" ","&nbsp;",str_pad($row{"rent_no"} , 27-strlen($row{"rent_no"}))).
						$row{"date"};
						echo"</option>";
						$result++;
						$row = mysqli_fetch_assoc($result);
					...
					{
						$sql = "SELECT * FROM 租借紀錄 where mem_id='$id' AND date LIKE '$rkeyword%' ORDER BY date";
						$result = execute_sql($link, "nuk_rent_3", $sql);
						$row = mysqli_fetch_assoc($result);
						$num = mysqli_num_rows($result);
						for($i=0;$i<$num;$i++)
