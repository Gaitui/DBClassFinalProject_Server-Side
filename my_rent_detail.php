...
<div id="header-wrapper">
		...
		<tr><td>時段及場地</td><td><?php if($row{"BBQ_time"}!="0")
										 {
											...
											if($row{"BBQ_time"}=="1")
												...
												echo"錯誤</br>";
											if($accept=="1" && $row{"deposit"}=="1")
											{
												$BBQ_no=$row{"BBQ_no"};
												echo"烤肉台編號:";
												for($i=0;$i<strlen($BBQ_no);$i++)
												{
													echo ord(substr($BBQ_no,$i,1))-ord('A')+1;
													if($i<strlen($BBQ_no)-1)
														echo".";
												}
												echo"</br>";
											}
										 ...
										 if($row{"camp_num"}!="0")
										 {
											 ...
											 if($accept=="1" && $row{"deposit"}=="1")
											{
												$camp_no=$row{"camp_no"};
												echo"營位編號:";
												for($j=0;$j<strlen($camp_no);$j++)
												{
													echo ord(substr($camp_no,$j,1))-ord('A')+1;
													if($j<strlen($camp_no)-1)
														echo".";
												}
												echo"</br>";
											}
			...
			<tr><td>繳費狀態</td><td><?if($row{"deposit"}=="0")
										{
											...
											{
												echo"逾期未繳費,請刪除申請單重新申請";
											}
											else
											{
												echo"尚未繳費,請在".$DL."前完成繳費";
											}
	...
	<div class="box">
	<?if($accept=="2" ||($accept=="1" && $row{"deposit"}=="0" && date('Y-m-d', time())>$DL))
	{?>
		<a href="my_rent_del.php" class="button">  刪除資料  </a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<?}
	else if($accept=="1" && $row{"deposit"}=="1");
	else
	{?>
		<a href="my_rent_change.php" class="button">  修改申請單  </a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<?}?>
